...
import ListagemBD from "../../components/listagemBD";
...
export default function Bluray() {
    ...
    const { addMovies, loadMoviesBD, moviesBD } = useContext(AuthContext);
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.registers}>
                <Text style={styles.registersText}>Registros: {moviesBD.length}</Text>
