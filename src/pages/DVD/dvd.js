...
import { View, Text, TouchableOpacity, StyleSheet, SafeAreaView, FlatList, Modal, TextInput, Pressable, Alert, Button } from "react-native";
...
import ListagemDVD from "../../components/listagemDVD";
...
export default function DVD() {
    ...
    const { addMovies, loadMoviesDVD, moviesDVD } = useContext(AuthContext);
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.registers}>
                <Text style={styles.registersText}>Registros: {moviesDVD.length}</Text>
